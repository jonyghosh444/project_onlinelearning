...
<p class="py-1">Whether you are an experienced programmer or not, this website is intended for everyone who wishes to learn the  Python programming <br> language.</p>
<p class="price ">$150</p>
   ...
   <form action="pythonbuyaction.php" method="post">
