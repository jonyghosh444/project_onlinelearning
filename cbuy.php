...
<p class="py-1">Whether you are an experienced programmer or not, this website is intended for everyone who wishes to learn the C programming language.</p>
<p class="price ">$80</p>




<form action="cbuyaction.php" method="post">

  <p><button type="submit"  name="submit" class="btn btn-primary"> SUBSCRIBE</button></p>
</form>

   <form action="cpayment.php" method="post">

  <p><button type="submit"  name="submit" class="btn btn-primary">Online Payment</button></p>
</form>
