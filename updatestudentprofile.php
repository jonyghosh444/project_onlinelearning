...
<div class="py-3">
	<a  style="color:Darkblue"  href="studenthomepage.php"> <b>Home<b></a>
</div>
...
<div class="col-lg-4 col-md-4 col-6 " >
	...
	<div class="col-lg-4 col-md-4 col-6 Tutorsignup">
		...
		<form action="supdate.php" method="POST" enctype="multipart/form-data">

			<?php

		  		$session_user = $_SESSION['username'];
          		$user_data = "SELECT * FROM studentsignup WHERE name='$session_user'";
